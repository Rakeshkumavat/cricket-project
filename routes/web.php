...
Route::get('/',[EmployeeController::class,'employeeForm'])->name('list_employee');
...
// Route::get('/events',[FamilyController::class,'events']);
    ...
    Route::get('/cricket-player-form',[CricketPlayerController::class,'cricketForm'])->name('cricket-palyer-form');
